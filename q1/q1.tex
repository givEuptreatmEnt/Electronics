...
\begin{circuitikz}[
  ...
  (0, 0) node[spdt, xscale=-1] (s1) {}
  (0, 3) node[spdt, xscale=-1] (s2) {}
  (0, 6) node[spdt, xscale=-1] (s3) {}
  (0, 9) node[spdt, xscale=-1] (s4) {}
  ...
  ($ (p1)+(0,-1) $) to[short, *-*] ++(1, 0) to[short] ++(0, 1) to[R, l=$R_f$] ++(3, 0) to[short, -*] ++(0, -1.5) to[short, -o] ++(.5, 0)node(p2){} to[open, v=$v_O$] ++(0, -2) node[ground]{}
  (op.-) to[short] ($ (p1)+(1,-1) $) 
  (op.+) node[ground]{}
  (op.out) to[short] (p2)
  ;

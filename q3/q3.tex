...
\begin{enumerate}[(a)]
  ...
  \item \Ans \\
    ...
    (Don't forget $r_o$).
  \item \Ans \\
    Since there is no current flowing into the ground of transistor, 
...
\begin{enumerate}[(a)]
  \item \Ans \\
    ...
    \]
  \item \Ans \\
    Because $r_o = 2 V_A / I_D = \SI{200}{\kohm}$ is to large, we shall neglecting on the following calculation.
    \[
